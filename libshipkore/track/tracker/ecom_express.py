...
class EcomExpress(BaseTrackService):
    ...
    def _transform(self):
        ...
        data = {
            ...
            'status': self.status_mapper(selector.xpath('/html/body/section/div/div/div[1]/div[2]/div/div[1]/p[4]/span//text()').get()),
            'substatus': selector.xpath('/html/body/section/div/div/div[1]/div[2]/div/div[1]/p[4]/span//text()').get(),
            'estimated_date': parse(selector.xpath('/html/body/section/div/div/div[1]/div[2]/div/div[1]/p[1]/span/span//text()').get().strip('hrs')),
            'delivered_date' : None,
            'reference_no' : selector.xpath('/html/body/section/div/div/div[1]/div[2]/div/div[3]/p/span//text()').get(),
            'destination' : '',
            'receiver_name': ''
        }
        checkpoints = []
        checkpoint_table = selector.xpath('/html/body/section/div/div/div[2]/div/div/div[2]')
