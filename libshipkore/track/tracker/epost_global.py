...
class EpostGlobal(BaseTrackService):
    ...
    def _transform(self):
        ...
        sub_status = selector.xpath('//*[@id="TableParcelTracker"]/tbody/tr[1]/td[2]/text()').get()
        ...
        if sub_status == StatusChoice.Delivered.value:
            delivered_date= selector.xpath('//*[@id="TableParcelTracker"]/tbody/tr[1]/td[3]/text()').get().split()[0]
            delivered_time= selector.xpath('//*[@id="TableParcelTracker"]/tbody/tr[1]/td[3]/text()').get().split()[1]
        ...
        data = {
            ...
            'estimated_date': parse(delivered_date+' '+delivered_time) if delivered_date else None,
            'delivered_date' : delivered_date,
            'delivered_time' : delivered_time,
            'reference_no' : '',
            'destination' : selector.xpath('//*[@id="TableParcelTracker"]/tbody/tr[1]/td[5]/text()').get(),
            'receiver_name': ''
        }

        checkpoints = []
        checkpoints_data= []
        checkpoint_table = selector.xpath('//*[@id="TableParcelTracker"]/tbody/tr[1]/td[7]')
